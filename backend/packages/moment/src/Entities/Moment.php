...
class Moment extends Model
{
    ...
    {
        return $this->hasMany(ReportMoment::class, 'moment_id', 'id');
    }

    /** Reports filed against this moment's comments (separate from post reports). */
    public function commentReports()
    {
        return $this->hasMany(ReportMomentComment::class, 'moment_id', 'id');
    }
