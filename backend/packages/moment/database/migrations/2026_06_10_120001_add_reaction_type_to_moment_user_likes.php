...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasColumn('moment_user_likes', 'reaction_type')) {
            return;
        }

        Schema::table('moment_user_likes', function (Blueprint $table) {
            // Facebook-style reaction: like/love/haha/wow/sad/angry. Existing
            // rows default to 'like'. One reaction per user per moment.
