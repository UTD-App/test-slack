      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              context.trArgs(AudioRoomKeys.inviteToSeat, {'index': '${widget.seatIndex + 1}'}),
            ...
            if (users.isEmpty)
              Padding(
                ...
                child: Text(
                  context.tr(AudioRoomKeys.noAudienceMembers),
  ...
  Future<void> _invite(UTDParticipant user) async {
    ...
    if (result != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(context.trArgs(AudioRoomKeys.invitationSentTo, {'name': user.name}))),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(context.tr(AudioRoomKeys.invitationFailed))),
      );
    }
  }
}
