...
import '../profile/profile_action_button.dart';
    ...
    return ValueListenableBuilder<Set<String>>(
      ...
      builder: (context, muted, _) {
        ...
        return ProfileActionButton(
          icon: Icons.mic_off,
          label: context.tr(AudioRoomKeys.mute),
          onTap: () async {
            ...
            if (context.mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text(ok ? context.tr(AudioRoomKeys.userMuted) : context.tr(AudioRoomKeys.failed))),
              );
            }
          },
        );
