            ...
            return _PinnedMessageBanner(
              ...
              onUnpin: () {
                ...
                context.read<RoomManagementBloc>().add(
                  UnpinMessageEvent(roomId: widget.roomId),
                );
              },
            );
          },
  ...
  Widget _buildTabBar(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildTabItem(title: context.tr(AudioRoomKeys.allTab), type: _MessageTab.all),
          _buildTabItem(title: context.tr(AudioRoomKeys.messagesTab), type: _MessageTab.messages),
        ],
      ),
    );
  }
              ...
              GestureDetector(
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(context.tr(AudioRoomKeys.messageUnpinned))),
                  );
                },
                child: Padding(
