...
Future<bool> showSpeakerInvitationDialog(
  ...
  String inviterName = data['inviter_name']?.toString() ?? context.tr(AudioRoomKeys.host);
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            context.trArgs(AudioRoomKeys.invitationToMic, {'index': '${seatIndex + 1}'}),
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  ...
                  child: Text(
                    context.tr(AudioRoomKeys.decline),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    context.tr(AudioRoomKeys.accept),
