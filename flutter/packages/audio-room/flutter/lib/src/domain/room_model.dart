...
class RoomModel extends RoomEntity {
  ...
  RoomModel copyWith({
    ...
    String? roomIntro,
    String? roomRule,
    String? Function()? roomBackground,
    bool? hasPassword,
    int? mode,
    int? visitorCount,
    ...
    Map<String, dynamic>? Function()? pinnedMessage,
  }) {
    return RoomModel(
      id: id,
      numId: numId,
      ...
      roomBackground: roomBackground != null ? roomBackground() : this.roomBackground,
      ...
      pinnedMessage: pinnedMessage != null ? pinnedMessage() : this.pinnedMessage,
      isOwner: isOwner,
